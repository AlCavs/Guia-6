 ...
 * que se podrán realizar son las siguientes: • Método getDiscriminante():
 * devuelve el valor del discriminante (double). El discriminante tiene la
 * siguiente formula: (b^2)-4*a*c • Método tieneRaices(): devuelve un booleano
 * indicando si tiene dos soluciones, para que esto ocurra, el discriminante
 * debe ser mayor o igual que 0. • Método tieneRaiz(): devuelve un booleano
 * indicando si tiene una única solución, para que esto ocurra, el discriminante
 * debe ser igual que 0. • Método obtenerRaices(): llama a tieneRaíces() y si
